      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-6 sm:grid-cols-2 md:grid-cols-3 md:px-8 lg:px-10">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="mt-2 flex gap-3">
            ...
            {/* Mail Icon */}
            <a href="mailto:hammadt451@gmail.com" className="flex h-10 w-10 items-center justify-center rounded-full border border-outline-variant/30 bg-surface-container text-on-surface-variant hover:border-primary/50 hover:text-primary transition-all">
        ...
        <div className="flex flex-col gap-4">
          <h3 href="/Contact.jsx" className="text-xs font-semibold uppercase tracking-[0.2em] text-outline">
            Contact
          </h3>
          <div className="flex flex-col gap-1 text-sm font-medium text-on-surface/90">
            <a href="mailto:hammadt451@gmail.com" className="hover:text-primary transition-colors">
          ...
          <div className="mt-2 flex flex-col gap-3 max-w-xs">
            {/* Outline Button: Secondary Container Alpha with Secondary Text */}
            <button href="/Contact.jsx" className="flex items-center justify-center gap-2 rounded-lg border border-secondary/30 bg-secondary-container/10 px-4 py-2.5 text-sm font-medium text-secondary hover:bg-secondary-container/20 transition-all">
